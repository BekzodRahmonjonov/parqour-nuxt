<template>
  ...
  >
    <div class="hidden md:flex items-center">
      ...
      <div class="w-5 h-px bg-white-300 ml-1 transition-300 dark:bg-blue-600" />
      <div
    ...
    <div>
      ...
      <p
        class="mt-3 text-lg leading-130 font-normal text-blue-900 transition-300 dark:text-white"
      >
        {{ card?.title }}
      </p>
    </div>
...
<style scoped>
.bullet-shadow {
  box-shadow: 0 0 10px rgba(162, 188, 222, 0.6);
}
</style>
