<template>
  <div class="bg-white h-[100vh] w-full bg-opacity-80">
    <div class="py-[100px] relative flex" v-if="showPush">
      <div class="relative mx-auto max-w-[450px] flex flex-col items-center bg-[white] p-7 rounded-xl">
        <div class="absolute -top-8 -right-8 hover:cursor-pointer" @click="closePush()">
        ...
        <div class="text-center">
          ...
          <p class="text-sm">
            Подпишитесь на рассылку, чтобы первыми узнавать обо всех горячих новостях
          </p>
        </div>
        <div class="mt-11">
          <div>
            <CommonButton variant="secondary" class="flex gap-1.5 max-w-[326px] w-full md:w-[326px]">
              <div>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                      ...
                      fill="#52618F"/>
                  <path d="M11.25 14.25H6.75" stroke="#52618F" stroke-width="1.5" stroke-linecap="round"
          ...
          <div class="mt-4">
            <CommonButton variant="primary-dark" class="flex gap-1.5 w-full">
              <div>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                      ...
                      fill="white"/>
                  <path d="M5.625 14.25C6.11627 15.5608 7.44184 16.5 9 16.5C10.5582 16.5 11.8837 15.5608 12.375 14.25"
    ...
    <div class="container grid grid-cols-4 grid-rows-3 gap-8">
      <div
          class="flex flex-col justify-between bg-gradient-to-b from-[#F6B175] to-[#BA4D4D] h-[362px] rounded p-5 hover:mt-1 hover:cursor-pointer duration-300 hover:shadow-m">
        <p class="font-semibold text-white pb-3 text-center uppercase border-white/20 border-b-2 text-xs">
          рaзбор
        </p>
        <p class="text-xl text-white font-semibold">
          Как идет ваша торговля на сайтах объявлений
        </p>
      </div>
      <div
          class="bg-gradient-to-b from-[#008E8E] to-[#1C4D36] h-[362px] rounded p-5 hover:mt-1 hover:cursor-pointer duration-300 hover:shadow-m">
        <p class="font-semibold text-white pb-3 text-center uppercase border-white/20 border-b-2">
          рaзбор
        </p>
        <p>
      ...
      <div
          class="bg-gradient-to-b from-[#65BDEF] to-[#2C5A9E] h-[362px] rounded p-5 hover:mt-1 hover:cursor-pointer duration-300 hover:shadow-m">
        <p class="font-semibold text-white pb-3 text-center uppercase border-white/20 border-b-2">
          рaзбор
        </p>
        <p>
      ...
      <div
          class="bg-gradient-to-b from-[#B181EB] to-[#5B2C93] h-[362px] rounded p-5 hover:mt-1 hover:cursor-pointer duration-300 hover:shadow-m">
        <p class="font-semibold text-white pb-3 text-center uppercase border-white/20 border-b-2">
          рaзбор
        </p>
        <p>
