<template>
  <button
    class="category-button py-[7px] px-2 rounded-[30px] text-sm font-medium leading-130 text-blue-200 transition-colors duration-200 hover:!bg-blue-100/40 capitalize"
