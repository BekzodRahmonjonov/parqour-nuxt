...
<!--      </div>-->
      <div class="flex">
        <span class="relative w-13 h-13">
          <span class="absolute rounded-full -top-2 -right-2 cursor-pointer bg-slate-700 w-5 h-5 text-center"><i class="icon-close text-white"></i></span>
          <img height="54" width="54" class="rounded" :src="img" alt="">
        </span>
      </div>
     <div class="relative mt-2"> <i
