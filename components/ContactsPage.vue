<template>
  <div class="page">
    <header class="header">
      <div class="container">
        <TheHeader :header-btn="headerBtn" />
        <main class="header__main">
          ...
          <p v-if="pages.length && pages[0].subtitle" class="header__main-text">
            {{ pages[0].subtitle }}
          </p>
          ...
          <div class="header__locations bg-image">
            <div v-for="(item, index) in contacts" :key="index">
              <div class="header__locations-item">
                <div class="header__locations-cord" :class="item.map_location">
                  <span></span>
                </div>
                <div class="header__locations-clue" :class="item.map_location">
                    <img :src="baseUrl + item.flag_icon" :alt="item.flag_icon">
                  <!-- <img
