<template>
    <div v-if="!route.path.includes('solutions')" @click="openVideo"
    ...
    <section v-if="!route.path.includes('solutions')" class="whyus container">
        <div class="whyus__left">
            ...
            <ul class="whyus__facts">
                ...
                <li class="whyus__facts-item">{{ $t('why-parqour-text-5') }}
    ...
    <section 
        ...
        :key="index"
    >
        <div class="half-bg" :style="{ 'background-image': `url(${imgUrl + item.image?.url})` }"></div>
        <div class="container">
            <div class="half-wrapper">
                <div class="half__content" v-html="item.content">
                </div>
            </div>
        </div>
    </section>
