<template>
  <div
    class="relative inline-flex items-center transition-300 relative rounded overflow-hidden w-full px-4 py-3 group border border-transparent focus-within:border-blue-100 focus-within:!bg-white dark:focus-within:!bg-transparent focus-within:hover:!bg-white !bg-blue-100/10 !dark:bg-blue-100/[16%] hover:!bg-blue-100/50"
